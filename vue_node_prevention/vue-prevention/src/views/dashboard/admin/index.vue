...
export default {
  ...
  methods: {
    handleSetLineChartData(type) {
      if (type === 'newVisitis') {
        this.data1 = '成都每日核酸检测情况'
        this.data2 = '西油每日核酸检测情况'
      }
      if (type === 'messages') {
        this.data1 = '成都每日健康表填报情况'
        this.data2 = '西油每日健康表填报情况'
      }
      if (type === 'purchases') {
        this.data1 = '成都每日高危人数情况'
        this.data2 = '西油每日高危人数情况'
      }
      if (type === 'shoppings') {
        this.data1 = '成都每日经过高危地区人数情况'
        this.data2 = '西油每日经过高危地区人数情况'
      }
